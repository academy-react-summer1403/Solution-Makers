    ...
    <div className="container mt-20">
      <div className="flex flex-col gap-24 justify-center items-center md:items-stretch md:flex-row">
        <div className="relative w-full md:w-1/2 flex flex-col justify-center">
          <div className="hidden md:block absolute md:top-[25px] lg:top-[110px] xl:top-28 bg-[url(/src/assets/images/courses/quarterCircle.png)] bg-no-repeat h-[104px] w-[104px]"></div>
          <div className="hidden md:block absolute md:top-[235px] md:-right-12 lg:top-[250px] lg:-right-10 xl:top-[265px] right-10 bg-[url(/src/assets/images/courses/horizontalDots.png)] bg-no-repeat w-[468px] h-[154px]"></div>

          <div className="w-[196px] h-[154px] hidden md:block absolute md:top-[60px] md:right-[300px] lg:top-[100px] lg:right-[450px] xl:top-[120px] bg-[url(/src/assets/images/courses/verticalDots.png)] bg-no-repeat"></div>
